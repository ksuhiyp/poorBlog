...
describe('User Controller', () => {
  ...
  describe('create', () => {
    ...
    it('should throw if the username was already taken', () => {
      ...
      return expect(controller.create(user)).rejects.toThrow(
        new Error(`Username ${user.username} already exists`),
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw if user was not found', () => {
      ...
      return expect(controller.update(user, 1)).rejects.toThrow(
        new Error('Not found'),
      );
    });
  });
  describe('Delete', () => {
    it('Should return undefined if deletion succeed', () => {
      ...
      jest
        ...
        .mockImplementation(() =>
          Promise.resolve<DeleteResult>({ raw: undefined, affected: 1 }),
        );
    ...
    it('Should throw if user was not found', () => {
      ...
      return expect(controller.delete(1)).rejects.toThrow(
        new Error('Not found'),
      );
    });
  });
